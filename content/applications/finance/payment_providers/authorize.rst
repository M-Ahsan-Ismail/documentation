...
.. tip::
   If you need to recreate the webhook (for example, after changing your domain), click
   :guilabel:`Re-generate Your Webhook`. Odoo will create a new webhook with the updated
   configuration.
