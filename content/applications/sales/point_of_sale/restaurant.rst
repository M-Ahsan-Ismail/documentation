...
.. important::
   ...
   under the :guilabel:`Point of Sale` section in the :ref:`POS settings <pos/use/settings>`.
...
.. tip::
   ...
   :ref:`POS settings <pos/use/settings>`. Under :guilabel:`Floors & Tables Map`, type the
...
.. seealso::
   :doc:`/applications/sales/point_of_sale/use/receipts`
